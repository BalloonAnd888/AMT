...
class AudioPlayer(QtWidgets.QWidget):
    ...
    def _setup_gui(self):
        ...
        self.vol_s = QtWidgets.QSlider(QtCore.Qt.Orientation.Vertical)
        ...
        self.pos_s = DecimalSlider(
            0, 0, self.num_decimals, QtCore.Qt.Orientation.Horizontal)
    ...
    def is_playing(self):
        """
        """
        x = self.media_player.playbackState() == QtMultimedia.QMediaPlayer.PlaybackState.PlayingState
        return x
    ...
    def set_array(self, arr, samplerate):
        ...
        self.media_player.setSourceDevice(self.current_qstream, QtCore.QUrl())
